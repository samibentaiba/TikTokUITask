        ...
        <div tabIndex="-1" {...attrs}>
            ...
            >
                ...
                <div className={cx('preview-header')}>
                    <Link to={`/@${userName}`} className={cx('wrapper')} state={accountInfo}>
                ...
                {/* Body */}
                <Link to={`/@${userName}`} className={cx('preview-body')} state={accountInfo}>
                ...
                <footer className={cx('preview-footer')}>
                    ...
                    <span className={cx('user-status-title')}>Following</span>
